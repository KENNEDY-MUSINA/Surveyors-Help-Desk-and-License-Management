...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="dash_approved.css">
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    <script src="./ajax/approv.js"></script>
...
<body id="page-top">
   <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <!-- Begin Page Content -->
         <div class="container">
             <h2>License Applicants to be Approved!</h2>
        <hr>
    
        <button class="btn btn-success">Division Manger</button>
    <p id="success"></p>
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons"></i> <span>Send for Recommendation</span></a>
            ...
            <table class="table table-striped table-hover">
                ...
                <?php
                $result = mysqli_query($conn,"SELECT * FROM approved_app");
                    $i=1;
                ...
                <tr id="<?php echo $row["id"]; ?>">
                    ...
                    <td>
                        <a href="#editModal" class="edit" data-toggle="modal">
                            ...
                            data-ref_no="<?php echo $row["ref_no"];?>"
                            title="Edit"></i>
                        </a>
    ...
    <div id="addEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post" action="../Backend/dashboard/dash_sec.php">
                    <div class="modal-header">                      
                        <h4 class="modal-title">Recommend the applicant</h4>
                        ...
                        <input name="email" class="form-control validate" required>
                        </div>
                        <div class="md-form md-5">
                        <label data-error="wrong" data-success="right" for="form3">Remarks
                        </label>
                        <select name="recomm" id="farm-select">
                        ...
                        <div class="md-form">
                        <label data-error="wrong" data-success="right" for="form3">Reason for recommendation</label>
                        <textarea  name="remark" class="form-control validate"></textarea>
                    </div>
                    </div>
                    <br>
        ...
        <footer class="sticky-footer bg-gradient-dark">
            ...
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span href="#">musinakennedy@gmail.com Copyright &copy; Your Website 2022</span>
                </div>
            </div>
        </footer>
