...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="dash_participant.css">
...
<body id="page-top">
   <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <!-- Begin Page Content -->
         <div class="container">
            <h2>License Applicants waiting to be Approved!</h2>
            <hr>
    
            <button class="btn btn-success">Head of Department Approval</button>
            <p id="success"></p>
            ...
            <table class="table table-striped table-hover">
                ...
                <?php
                $result = mysqli_query($conn,"SELECT * FROM landLicense_app");
                    $i=1;
                ...
                ?>
                            <td><?php echo $i; ?></td>
                            <td><?php echo $row["board_land"]; ?></td>
                            <td><?php echo $row["membership"]; ?></td>
                            <td><?php echo $row["app_letter"]; ?></td>
                            <td><?php echo $row["survey_act"]; ?></td>
                            <td><?php echo $row["surveyors_board"]; ?></td>
                        </tbody>   
                </tr>
                <?php
                $i++;
