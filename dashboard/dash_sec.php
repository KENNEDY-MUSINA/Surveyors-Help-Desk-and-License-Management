...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="dash_sec.css">
...
<body id="page-top">
   <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <button class="btn btn-success">Secretariet</button>
    <p id="success"></p>
            ...
            <div class="modal-content">
                <form id="user_form">
                    <div class="modal-header">                      
                        ...
                        <select name="farm_survey" id="farm-select">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-success" id="btn-add">Send</button>
                    </div>
                </form>
            </div>
        </div>
